        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-8 pb-12">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="flex items-center gap-3 text-gray-400 pt-1">
              {/* Facebook */}
              <a href="https://www.facebook.com/CercasBalkran" target="_blank" rel="noopener noreferrer" className="hover:text-[#ff5a00] transition-colors" aria-label="Facebook">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* WhatsApp */}
              <a href="https://wa.me/573114508064?text=Hola%20Balkran%2C%20quisiera%20recibir%20asesor%C3%ADa" target="_blank" rel="noopener noreferrer" className="hover:text-[#25D366] transition-colors" aria-label="WhatsApp">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/cercasbalkran/" target="_blank" rel="noopener noreferrer" className="hover:text-[#ff5a00] transition-colors" aria-label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+573114508064" className="hover:text-[#ff5a00] transition-colors">+57 311 450 8064</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-3.5 h-3.5 text-gray-400 shrink-0" />
                <a href="mailto:ventas@cercasbalkran.com" className="hover:text-[#ff5a00] transition-colors">ventas@cercasbalkran.com</a>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="w-3.5 h-3.5 text-gray-400 shrink-0 mt-0.5" />
                <span>{t('footer.cobertura')}</span>
              </li>
            </ul>
          </div>
